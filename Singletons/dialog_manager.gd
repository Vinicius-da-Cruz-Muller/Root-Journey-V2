...
func show_text():
	...
	can_advange_message = false

func _on_all_text_displayed():
	can_advange_message = true
	
func _unhandled_input(event):
	if(event.is_action_pressed("advance") && is_message_active && can_advange_message):
